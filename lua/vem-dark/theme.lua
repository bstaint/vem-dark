...
M.highlights = function()
  ...
  -- Spelling
  hi('SpellBad', {sp = c.vemRed, underline = true, ctermfg = c.vemTermBlack, ctermbg = c.vemTermRed, cterm = vemTermUnderline })
  hi('SpellCap', {sp = c.vemGreen, underline = true, ctermfg = c.vemTermHiFront, ctermbg = c.vemTermHiBlue, cterm = vemTermUnderline })
  hi('SpellRare', {sp = c.vemGreen, underline = true, ctermfg = c.vemTermHiFront, ctermbg = c.vemTermHiOrange, cterm = vemTermUnderline })
  hi('SpellLocal', {sp = c.vemBlue, underline = true, ctermfg = c.vemTermHiFront, ctermbg = c.vemTermHiGreen, cterm = vemTermUnderline })
  -- Messages
